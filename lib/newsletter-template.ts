...
function buildFooter(): string {
  return `<table role="presentation" class="stb-one-col" style="width: 100%;border:0;" cellpadding="0" cellspacing="0"><tbody><tr><td style="text-align:center;font-size:0;box-sizing:border-box;padding:15px 15px 0 15px;"><a href="https://slashpage.com/teamjcurve" target="_blank" style="text-decoration: none; color: ${BRAND_COLOR};"><img src="https://img2.stibee.com/118801_3148150_1766133730164823362.png" alt="" style="width:160px;display:inline;vertical-align:bottom;text-align:center;max-width:100% !important;height:auto;border:0;" width="160" class="stb-center"></a></td></tr><tr><td style="word-break:break-all;text-align:left;margin:0px;line-height:1.7;word-break:break-word;font-size:16px;font-family:${FONT_FAMILY}!important;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color:#333333;padding:20px 15px 15px 15px;"><div style="text-align: center;"><span style="font-style: italic; font-size: 14px;">AI의 실전 활용과 정보가 가득한</span></div><div style="text-align: center;"><span style="font-style: italic; font-size: 14px;">AI Native Lab 방문하기</span></div></td></tr></tbody></table>
